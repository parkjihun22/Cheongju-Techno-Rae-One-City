  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        {/* SEO 최적화를 위한 메타 태그 */}
        <title>브레인시티 푸르지오 - 단지배치도</title>
        <meta
          name="description"
          content="평택브레인시티푸르지오의 단지 배치도를 통해 각 동의 위치와 편의시설의 배치를 확인하세요. 효율적인 동선 설계와 조경 공간, 입주민의 생활 편의를 고려한 배치를 상세히 안내합니다.
											"
        />
        <meta
          name="keywords"
      ...
      <p className={styles.screenReaderOnly}>
        단지 배치도 페이지는 평택브레인시티푸르지오의 전체 단지 구성도를
