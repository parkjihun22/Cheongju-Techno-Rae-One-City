...
const FloorPlan1 = () => {
	...
	<Helmet>
			...
			{/* SEO 최적화를 위한 메타 태그 */}
			<title>브레인시티 푸르지오 - 평면안내</title>
			<meta
			  name="description"
			  content="평택브레인시티푸르지오의 평면도를 통해 세대별 구조와 공간 활용도를 확인하세요. 실용적이고 혁신적인 설계를 기반으로 한 다양한 평면 구성이 여러분의 생활을 더 편리하게 만듭니다.
												"
			/>
			<meta
			  name="keywords"
