...
<Helmet>
		...
		{/* SEO 최적화를 위한 메타 태그 */}
		<title>브레인시티 푸르지오 - 입지환경</title>
		<meta
		  name="description"
		  content="평택브레인시티푸르지오의 입지 정보를 확인하세요. 뛰어난 교통망, 생활 인프라, 교육 및 쇼핑 시설 등 편리한 주변 환경을 소개하며, 평택의 중심에서 누릴 수 있는 생활의 편리함과 가치를 제공합니다
											"
		/>
		<meta
		  name="keywords"
		  ...
		  {`
								{
									...
									"@type": "WebPage",
									"name": "브레인시티 푸르지오 - 입지환경",
									"description": "평택브레인시티푸르지오의 입지 정보를 확인하세요. 뛰어난 교통망, 생활 인프라, 교육 및 쇼핑 시설 등 편리한 주변 환경을 소개하며, 평택의 중심에서 누릴 수 있는 생활의 편리함과 가치를 제공합니다
